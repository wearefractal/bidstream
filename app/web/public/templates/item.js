define(function() {
  return function anonymous(target, o, op) {
    ...
    return rivets.bind($(target)[op](function anonymous(locals, attrs, escape, rethrow, merge) {
      ...
      var __jade = [ {
        lineno: 1,
        filename: "/home/contra/Projects/bidstream/app/web/client/templates/item.jade"
      } ];
      try {
        var buf = [];
        with (locals || {}) {
          ...
          __jade.unshift({
            lineno: 1,
            filename: "/home/contra/Projects/bidstream/app/web/client/templates/productImage.jade"
          });
          __jade.unshift({
            lineno: 1,
            filename: __jade[0].filename
